...
export const products: Product[] = [
  ...
  },
  {
    ...
    price: 56.99,
    description: "Note: The Jackets is US standard size. Material: 100% Polyester. Detachable Liner Fabric: Warm Fleece.",
  ...
  },
  {
    ...
    price: 7.95,
    description: "100% Polyester, Machine wash, 100% cationic polyester interlock. Lightweight, roomy and highly breathable.",
    category: "women's clothing",
